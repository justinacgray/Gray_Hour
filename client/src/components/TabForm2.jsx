...
const TabForm = ({ tabsArray }) => {
    ...
    return (
        <div className=''>
            <form style={{backgroundColor: '#16B3B6'}} onSubmit={handleSubmit} className="d-flex p-2 outer-form-container">
                ...
                <div className="me-3">
                    <label className="form-label"> Tab Width
                        <input type="number" className="form-control" disabled name="boxWidth" value={colorObj.boxWidth} onChange={handleChange} />
                    </label>
                </div> 
                <div className="me-3">
                    <label className="form-label"> Tab Height
                        <input type="number" className="form-control"disabled name="boxHeight" value={colorObj.boxHeight} onChange={handleChange} />
                    </label>
                </div>
