...
const TabForm = ({ tabsArray }) => {
    ...
    return (
        <div className=''>
            <form style={{backgroundColor: '#75B950'}} onSubmit={handleSubmit} className="d-flex p-2  outer-form-container">
                <div className="me-3">
                    <label className="form-label"> Tab Color
                        <input type="color" className="form-control" name="boxColor" disabled value={colorObj.boxColor} onChange={handleChange} />
                    </label>
                </div>
                <div className="me-3">
